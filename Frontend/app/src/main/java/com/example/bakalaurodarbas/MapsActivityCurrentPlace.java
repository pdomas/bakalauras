    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_menu.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(MapsActivityCurrentPlace.this,MainActivity.class));
            }
        });
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(MapsActivityCurrentPlace.this,SearchActivity.class));
            }
        });
...
//    };
    ...
    public void onMapReady(GoogleMap map) {
        ...
        LocationDataService locationDataService = new LocationDataService(MapsActivityCurrentPlace.this);
        locationDataService.getJSONArryOfLocations(new LocationDataService.VolleyResponseListener() {
            @Override
