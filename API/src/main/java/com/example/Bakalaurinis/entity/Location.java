...
public class Location {
    ...
    public Location(UUID location_id, @NotBlank String latitude, @NotBlank String longitude, @NotBlank String location_address, @NotBlank double price_per_hour, @NotBlank String contact_info, boolean reservation_status) {
